...
--
-- Servidor: 127.0.0.1
-- Tiempo de generación: 14-08-2026 a las 02:27:48
...
CREATE TABLE `comodin` (
  ...
  `imagen_ancho` int(11) DEFAULT NULL,
  `imagen_alto` int(11) DEFAULT NULL
...
(90, 'historia de iron man', 0, 11, '', 0, 'comodin.php'),
(91, 'san martin', 0, 11, '', 0, 'comodin.php');
...
(11, 'Electronica Aplicada', 'EA', '    E.E.T.N°1 - Lunes                                                                                                                            ', '           Materia de 7° año de la tecnicatura en Electronica                                                                                                              ', 'logo_t1.png', 1, 1, '#0d0d0d', '#c20f0f'),
...
--
ALTER TABLE `secciones`
  MODIFY `id_seccion` int(4) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=92;
